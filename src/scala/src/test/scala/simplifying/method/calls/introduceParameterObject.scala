...
class introduceParameterObject extends AnyFunSuite {
  private val accountingService = new AccountingService(
    List(
      Bill(
        ...
        paymentDate = Some(LocalDate.of(2020, 12, 1))
      ),
      Bill(
        67_987,
      ...
      Bill(
        ...
        paymentDate = Some(LocalDate.of(2020, 10, 10))
      ),
      Bill(
        156_987,
        invoicedDate = LocalDate.of(2020, 10, 9),
      ...
      Bill(
        ...
        paymentDate = Some(LocalDate.of(2020, 1, 16))
      ),
      Bill(
        98_765,
        invoicedDate = LocalDate.of(2020, 12, 31),
        dueDate = LocalDate.of(2021, 2, 1),
        paymentDate = Some(LocalDate.of(2021, 1, 2))
      )
    )
  )
  ...
  test("find bills invoiced between 2 dates") {
    assertResult(
      accountingService.findBillsInvoicedBetween(
        Period(LocalDate.of(2020, 1, 1), LocalDate.of(2020, 12, 31))
      ),
      expectedSize = 6,
  ...
  test("find bills due between 2 dates") {
    assertResult(
      accountingService.findBillsDueBetween(
        Period(LocalDate.of(1980, 10, 1), LocalDate.of(2019, 1, 31))
      ),
      expectedSize = 1,
  ...
  test("find bills paid between 2 dates") {
    assertResult(
      accountingService.findBillsPaidBetween(
        Period(LocalDate.of(1980, 10, 1), LocalDate.of(2020, 12, 31))
      ),
      expectedSize = 4,
